...
class UpvotePerson extends AbstractController implements ActionRequiresAuthorization
{
...
mutation($id: Int!, $user_id: Int!, $created: timestamp) {
    insert: insert_rating_point_one(
        object: {person_id: $id, type: "upvote", user_id: $user_id, created_at: $created},
